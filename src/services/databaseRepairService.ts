...
export const REPAIR_CAPABILITY_MATRIX: Record<string, RepairCapability> = {
  ...
  // Phase 17: Immutable Audit Trail Unsafe Repair Protections
  ORPHAN_AUDIT_REFERENCE: {
    code: 'ORPHAN_AUDIT_REFERENCE',
    title: 'ကျိုးပေါက်နေသော Audit အကိုးအကား (Orphan Audit Reference)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'မပြောင်းလဲနိုင်သော Audit စာရင်းအား အလိုအလျောက် ဖျက်ဆီးပြင်ဆင်ခွင့် မပြုပါ။ သမိုင်းဝင် အမွေအနှစ်မှတ်တမ်းအဖြစ် ထိန်းသိမ်းထားပါသည်',
  },
  DUPLICATE_AUDIT_ID: {
    code: 'DUPLICATE_AUDIT_ID',
    title: 'ထပ်နေသော Audit ID (Duplicate Audit ID)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'Audit မှတ်တမ်းများ ထပ်နေပါက စနစ်လုံခြုံရေးအရ အလိုအလျောက် ဖျက်ဆီးခြင်း မပြုပါ',
  },
  INVALID_AUDIT_REFERENCE: {
    code: 'INVALID_AUDIT_REFERENCE',
    title: 'မပြည့်စုံသော Audit အကိုးအကား (Invalid Audit Reference)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'Audit မှတ်တမ်းအချက်အလက်များအား ကိုယ်တိုင်သာ ကြည့်ရှုစစ်ဆေးခွင့်ပြုပါသည်',
  },
  MISSING_REVERSAL_LINK: {
    code: 'MISSING_REVERSAL_LINK',
    title: 'ပယ်ဖျက်မှု အချိတ်အဆက် မရှိခြင်း (Missing Reversal Link)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'အပြန်အလှန်ပယ်ဖျက်မှု မှတ်တမ်းများအား အလိုအလျောက် ပြင်ဆင်ခွင့်မပြုပါ',
  },
  ...
  ORPHAN_RETURN_REFERENCE: {
    code: 'ORPHAN_RETURN_REFERENCE',
    title: 'ကျိုးပေါက်နေသော အရောင်း/ဝယ်ယူမှု ပြန်အပ်အကိုးအကား (Orphan Return Reference)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'မူလဘောက်ချာမရှိတော့သော အရောင်း/ဝယ်ယူမှု ပြန်အပ်စာရင်းဖြစ်သဖြင့် ဘဏ္ဍာရေးစာရင်း သမိုင်းကြောင်းအား အလိုအလျောက် ပြင်ဆင်ခွင့်မပြုပါ',
  },
  DUPLICATE_RETURN_IDEMPOTENCY_KEY: {
    code: 'DUPLICATE_RETURN_IDEMPOTENCY_KEY',
    title: 'ထပ်နေသော ပြန်အပ်ငွေ Idempotency Key (Duplicate Return Idempotency Key)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'အထပ်ထပ် ဖြစ်နေသော ပြန်အပ်မှတ်တမ်းအား အလိုအလျောက် ဖျက်ပစ်ခွင့်မပြုပါ။ ကိုယ်တိုင် စစ်ဆေးရန် လိုအပ်ပါသည်',
  },
  EXCESSIVE_RETURN_QUANTITY: {
    code: 'EXCESSIVE_RETURN_QUANTITY',
    title: 'မူလထက် ပိုလွန်နေသော ပြန်အပ်အရေအတွက် (Excessive Return Quantity)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'မူလရောင်း/ဝယ် အရေအတွက်ထက် ပိုလွန်နေသော ပြန်အပ်စာရင်းအား ကိုယ်တိုင် စစ်ဆေးပြင်ဆင်ပါ',
  },
  MISSING_RETURN_REVERSAL_LINK: {
    code: 'MISSING_RETURN_REVERSAL_LINK',
    title: 'ပျက်ပြယ်နေသော ပြန်အပ်ပယ်ဖျက် လျှော်ကြေးမှတ်တမ်း (Missing Return Reversal Link)',
    repairAvailable: false,
    safetyLevel: 'LEVEL_C',
    isAutomatic: false,
    requiresUserConfirmation: false,
    description: 'ပယ်ဖျက်ထားသော ပြန်အပ်စာရင်း၏ စတော့/ငွေသား လျှော်ကြေးမှတ်တမ်း ပျောက်ဆုံးနေသဖြင့် ကိုယ်တိုင် စစ်ဆေးရန် လိုအပ်ပါသည်',
  },
  INVALID_DATE_FORMAT: {
